...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	ПечатьПриходнойнакладной(ТабДок, ПараметрКоманды);
...
//	ПараметрКоманды - Произвольный - содержит ссылку на объект, для которого вызвана команда печати.
&НаСервере
Процедура ПечатьПриходнойнакладной(ТабДок, ПараметрКоманды)
	Документы.ПриходнаяНакладная.ПечатьПриходнойнакладной(ТабДок, ПараметрКоманды);
КонецПроцедуры
